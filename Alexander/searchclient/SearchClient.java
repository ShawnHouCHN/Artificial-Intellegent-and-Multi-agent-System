...
public class SearchClient {
	...
	public int[] getDimensions(BufferedReader serverMessages)throws IOException{
		serverMessages.mark(999999);
	...
	public SearchClient(BufferedReader serverMessages) throws Exception {
		int[] dim = this.getDimensions(serverMessages);
		...
		this.initialState.MAX_ROW=dim[0];
		this.initialState.MAX_COL=dim[1];
		...
		//this.initialState.MAX_ROW = row+2;
		//this.initialState.MAX_COL = line.length()+2;
	}
