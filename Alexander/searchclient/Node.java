...
public class Node {
	...
	//When i changed initial value, it gave index error, so initial value is still 75, but changes right after initialization

	public static int MAX_ROW=75;
	public static int MAX_COL=75;
